---
title: "@md-oss/analytics"
description: "Thin helpers to wire analytics in Next.js apps: Vercel Analytics by default, Google Analytics when a measurement ID is present. Includes a typed env loader for NEXT_PUBLIC_GA_MEASUREMENT_ID."
