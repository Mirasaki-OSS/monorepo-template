...
ARG NEXT_PUBLIC_APP_NAME_SHORT
ENV NEXT_PUBLIC_APP_NAME_SHORT=$NEXT_PUBLIC_APP_NAME_SHORT
ARG NEXT_PUBLIC_APP_DESCRIPTION
ENV NEXT_PUBLIC_APP_DESCRIPTION=$NEXT_PUBLIC_APP_DESCRIPTION
ARG NEXT_PUBLIC_COPYRIGHT_HOLDER
ENV NEXT_PUBLIC_COPYRIGHT_HOLDER=$NEXT_PUBLIC_COPYRIGHT_HOLDER
