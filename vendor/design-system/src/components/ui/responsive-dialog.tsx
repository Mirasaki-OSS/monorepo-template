...
import { useAsRef } from '@md-oss/design-system/hooks/use-as-ref';
import { useIsomorphicLayoutEffect } from '@md-oss/design-system/hooks/use-isomorphic-layout-effect';
import { useLazyRef } from '@md-oss/design-system/hooks/use-lazy-ref';
...
function ResponsiveDialogContent({
	...
	// Note: Avoids native components auto-focusing on the first focusable element
	// Instead, let's target actual input/textarea/combobox elements for better accessibility
	const defaultHandleOpenAutoFocus = React.useCallback((event: Event) => {
		...
		const firstEditableControl = content.querySelector<HTMLElement>(
	...
	const handleOpenAutoFocus = onOpenAutoFocus ?? defaultHandleOpenAutoFocus;
